...
class cfgVehicles
{
	...
	RANGER_SOLDIER(75th_RF_MCT,"75th Ranger Rifleman MCT","RangerGreen",g3roll_mct, flb_CryeAVS_Assault01_GEAR_A_300_MCT,flb_opscover_peltor_C_03,RF_Items,RF_Linked,RF_WEP,RF_MAG,flb_mappack_Standard_mc);
};